...
*Last updated: 2026-05-31 — Phase 37C.1 (Settings Theme Mode Participation) shipped: Settings follows Light/Dark/System via mode-aware tokens; `panelBackground` mode-aware in `theme.ts`. Next: 37D (Global Visual Effects) → 37E (Appearance Cloud Sync).*
